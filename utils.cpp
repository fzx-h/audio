...
const gchar *utils::gvc_channel_position_to_pulse_string (MateMixerChannelPosition position)
{
...
const gchar *utils::gvc_channel_position_to_pretty_string (MateMixerChannelPosition position)
{
        g_return_val_if_fail (position >= 0 && position < MATE_MIXER_CHANNEL_MAX, NULL);
...
const gchar *utils::gvc_channel_map_to_pretty_string (MateMixerStreamControl *control)
{
